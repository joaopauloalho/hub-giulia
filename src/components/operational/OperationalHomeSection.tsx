import { AlertTriangle, ArrowRight, CalendarDays, CheckCircle2, Clock3, HeartHandshake, MessageCircle, RotateCcw, ShieldCheck } from 'lucide-react';
  ...
  return <section className="operational-home" aria-labelledby="operational-home-title">
    ...
    <div className="operational-grid">
      ...
      <div className="operational-side">
        ...
        <div className="card operational-summary"><strong>Próximos 7 dias</strong><div><span>Atendimentos</span><b>{hub.week.appointments}</b></div>{hub.week.overdue_returns > 0 && <div><span>Retornos atrasados</span><b>{hub.week.overdue_returns}</b></div>}{hub.week.aftercare > 0 && <div><span>Acompanhamentos</span><b>{hub.week.aftercare}</b></div>}{hub.week.relationship > 0 && <div><span>Relacionamento</span><b>{hub.week.relationship}</b></div>}{hub.week.expiring_credits > 0 && <div><span>Créditos próximos da validade</span><b>{hub.week.expiring_credits}</b></div>}</div>
